...
const RestaurantCard = (props) => {
  ...
  const { resData } = props;
  const { name, cuisines, avgRating, costForTwo, sla, areaName, locality } =
    resData?.info;
  return (
...
const resList = [
  ...
  },
  {
    info: {
      ...
      availability: {
        nextCloseTime: "2024-07-08 01:55:00",
        opened: true,
      },
      badges: {
        imageBadges: [
  ...
  },
  {
    info: {
      ...
      name: "Bakingo",
      cloudinaryImageId:
        "RX_THUMBNAIL/IMAGES/VENDOR/2024/7/5/d7258c1a-7498-4f01-9e25-f40afdf0c3d4_659837.jpg",
